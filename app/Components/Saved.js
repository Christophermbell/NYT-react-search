...
var Main = React.createClass({
    ...
    render: function() {
        ...
        if (this.state.savedArticles == "") {
            ...
            var articles = this.state.savedArticles.map(function(article, index) {
                return ( <
                    ...
                    <
                    a href = { article.url }
                    target = "_blank" > < button className = "btn btn-default " > View Article < /button></a >
                    <
                    button className = "btn btn-primary"
                    onClick = { this.handleClick.bind(this, article) } > Delete < /button> <
                    /span> <
                    /h3> <
        ...
        return ( <
            ...
            <
            h1 className = "panel-title" > < strong > < i className = "fa fa-download"
            aria - hidden = "true" > < /i> Saved Articles</strong > < /h1> <
            /div> <
